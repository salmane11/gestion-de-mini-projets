...
<html>
    ...
    <body>
        ...
        <div class="left">
            <br><br><br>
            <a href="ajouteretudiant.php">Ajouter des etudiants </a><br><br><br>
            <a href="confirmerinscription.php">Confirmer une inscription</a><br><br><br>
            <a href="visualiserutilisateurs.php">Visualiser les utilisateurs</a><br><br><br>
            <a href="miniprojet.php">Visualiser les mini-projets</a><br><br><br>
            <a href="ajouterAdmin.php">Ajouter un administrateur</a>
        </div>
        <div class="right">
        <?php include 'bd.php';?>
